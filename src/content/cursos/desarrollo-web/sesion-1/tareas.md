---
title: "Tarea 1: Análisis y Destrucción"
order: 5
type: "tarea"
deadline: "antes de la Sesión 2"
deliverable: "Un archivo `README.md` con tu propio Diccionario de Tailwind, una paleta de colores cambiada, y un commit de cierre que documente el proceso."
rubric:
  - criterio: "El README incluye una sección 'Diccionario de Tailwind' con al menos 5 clases explicadas con tus palabras."
    peso: 1
  - criterio: "Cambiaste al menos 3 colores de la página base usando la documentación oficial de Tailwind."
    peso: 1
  - criterio: "Indujiste al menos un error de estructura HTML (etiqueta sin cerrar) y otro de CSS (clase mal escrita); explicaste la diferencia en el README."
    peso: 1
  - criterio: "El repo tiene al menos 2 commits nuevos con mensajes descriptivos (uno por los cambios, otro de cierre)."
    peso: 1
  - criterio: "El último commit se llama algo como 'tarea: experimentación y debug intencional'."
    peso: 1
---
...
## Tarea 1: Reflexión y Disección (30 min)
...
## Tarea 2: Experimentación y Búsqueda Activa (1 h)
...
## Tarea 3: La Mentalidad "Rompe y Arregla" (Troubleshooting) (30 min)
