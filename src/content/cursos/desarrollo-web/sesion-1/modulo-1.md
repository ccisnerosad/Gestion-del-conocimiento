---
title: "Módulo 1: Astro y HTML Básico"
order: 1
duration: "45 min"
objectives:
  - "Crear un proyecto Astro desde cero con npm create astro@latest"
  - "Entender la anatomía de un archivo .astro: frontmatter, head, body"
  - "Distinguir entre etiquetas de bloque, en línea y semánticas en HTML"
---
    ...
    <main>
      ...
      <section>
        ...
        <div>
          ...
          empujan al resto del contenido a una nueva línea. Ejemplos: las cajas
